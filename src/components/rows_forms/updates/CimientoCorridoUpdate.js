...
const validationSchema = Yup.object().shape({
    ...
    export default function CimientoCorridoUpdate(props){

      const [cimiento, setCimiento] = useState({})

      useEffect(() => {
        api.get(`budgets/${props.budgetId}/cimcorridos/${props.rowId}`)
      ...
      return(
        <UpdateForm title='Cimiento Corrido' url='cimcorridos' rowUrl={`budgets/${props.budgetId}/rows/${props.rowId}`}
        rowId={props.rowId} budgetId={props.budgetId} rowData={props.rowData} rowsData={props.rowsData} setRowsData={props.setRowsData}
        actualData={cimiento} form={FormFields}  validationSchema={validationSchema}
