...
export default function IronSpecsForm(props){
  ...
  useEffect(() => {
    api.get(`budgets/${props.budgetId}/extmezclones/${props.rowId}`)
  ...
  return(
    <UpdateForm title='Mezclón de Concreto' url='extmezclones' rowUrl={`budgets/${props.budgetId}/rows/${props.rowId}`}
